...
def main():
    ...
    if not os.path.exists("looker.ini"):
        ...
        print("Please copy looker.ini.example to looker.ini and fill in your Looker API credentials.")
        sys.exit(1)

    print("Initializing Looker SDK...")
    # Initialize the SDK. By default, it looks for looker.ini in the current directory.
    ...
    try:
        ...
        me = sdk.me()
        print(f"Successfully authenticated as: {me.first_name} {me.last_name} (ID: {me.id})")
        ...
        # We fetch the created month and total revenue, limiting to last 12 months
        ...
        print(f"\nAn error occurred: {e}")
        print("Please check your looker.ini configuration and ensure your Looker instance is accessible and the model/explore exists.")
